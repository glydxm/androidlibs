...
public class SpacesItemDecoration extends ItemDecoration {
    ...
    private int topDecoration = 1;
    private int bottomDecoration = 1;
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize - bottomDecoration; i++) {

            // 获取当前子试图所在的位置
            int pos = parent.getChildLayoutPosition(parent.getChildAt(i));
            // 跳过这个item不画线
            if(pos <= topDecoration){
                continue;
            }
    ...
    public void removeTopDecoration(int position){
        topDecoration = position;
    }

    public void removeBottomDecoration(int position){
