...
import com.glyfly.librarys.imagepicker.data.DataSource;
import com.glyfly.librarys.imagepicker.data.LocalDataSource;
import com.glyfly.librarys.imagepicker.data.OnImagesLoadedListener;
import com.glyfly.librarys.imagepicker.widget.SuperCheckBox;
...
public class ImagesGridFragment extends Fragment implements OnImagesLoadedListener, AndroidImagePicker.OnImageSelectedListener, AndroidImagePicker.OnImageCropCompleteListener {
    ...
    private Button btnDir;//button to change ImageSet
