package com.glyfly.librarys.refreshrv;
...
import com.glyfly.librarys.refreshrv.callback.PullToRefreshListener;
...
public class RefreshHeader extends LinearLayout {
    ...
    private PullToRefreshRecyclerView.OnPullListener onPullListener;

    public void setOnPullListener(PullToRefreshRecyclerView.OnPullListener onPullListener){
    ...
    public RefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        refreshContentView = LayoutInflater.from(getContext()).inflate(
                R.layout.pull_layout_refresh_head_view, null);
    ...
    public void onMove(int move) {
        ...
        if (onPullListener != null) {
            onPullListener.onPull(getVisibleHeight());
        }
    }
    ...
    private void smoothScrollTo(int destHeight) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (onPullListener != null) {
                    onPullListener.onPull((int) animation.getAnimatedValue());
                }
            }
        });
        animator.start();
