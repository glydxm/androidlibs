...
public class PullToRefreshRecyclerView extends RecyclerView {
    ...
    public void setOnPullListener(OnPullListener onPullListener){
        refreshHeader.setOnPullListener(onPullListener);
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                //这里被RecyclerView拦截了，记录lastY放在dispatchTouchEvent
                lastY = e.getRawY();
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled && refreshHeader.getRefreshState() != RefreshHeader.STATE_REFRESHING) {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && pullToRefreshListener != null
            ...
            if (layoutManager.getChildCount() > 0 &&
                    ...
                    && refreshHeader.getRefreshState() != RefreshHeader.STATE_REFRESHING) {
