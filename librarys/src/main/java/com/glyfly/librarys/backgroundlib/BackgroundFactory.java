package com.glyfly.librarys.backgroundlib;
...
import com.glyfly.librarys.backgroundlib.drawable.DrawableFactory;
...
public class BackgroundFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(String name, Context context, AttributeSet attrs) {
        ...
        if (name.startsWith("com.glyfly.librarys.backgroundlib.view")) {
            return null;
        }
        View view = null;
