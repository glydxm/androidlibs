...
/**
 * Created by zhangfaming on 2017/8/31.
 */
...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public void deleteStartLine(int startLineNum){
        this.startLineNum = startLineNum;
    }

    public void deleteEndLine(int endLineNum){
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = startLineNum; i < childSize - endLineNum; i++) {
